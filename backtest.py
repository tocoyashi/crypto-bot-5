...
TIMEFRAME = '4h'   # Moved to 4-Hour timeframe
TOP_N_COINS = 50
DAYS_BACK = 60

# ================= Strategy Settings =================
LEVERAGE = 12
TP1_PERC = 2.0    # Realistic Swing Target
SL_PERC = 1.5     # Safe Stop Loss for 4H
# ========================================================
TP3_PERC = 4.0
TP6_PERC = 9.0
...
def run_backtest():
    print(f"=== Running Swing Trading Backtest (4H) ===")
    ...
    for symbol in top_coins:
        print(f"Backtesting {symbol} on 4H...")
    ...
    msg = f"""📊 <b>Swing Trading Backtest Report</b> ⏱️ {DAYS_BACK} Days
                         
🔍 <b>Tested Assets:</b> Top {TOP_N_COINS} MEXC Coins
📈 <b>Timeframe:</b> {TIMEFRAME} (Swing)
...
⚠️ <i>Target is 44% Win Rate to be profitable after MEXC fees.</i>"""

    print("Sending Swing report to Telegram...")
